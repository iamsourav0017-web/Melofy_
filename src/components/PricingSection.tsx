  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto space-y-14 relative z-10">
        ...
        {/* Section Header with Parallax Layer */}
        ...
        {/* Pricing Cards Grid: Staggered Parallax Tier Elevation */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {pricingTiers.map((tier, idx) => {
            ...
            // Parallax elevation displacement per tier
            const tierYRange: [number, number] = isRecommended ? [42, -38] : [24, -22];
        ...
        {/* Reassurance Banner with Parallax */}
        <ParallaxLayer yRange={[15, -15]}>
          <motion.div
            initial={shouldReduceMotion ? false : { opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={defaultViewport}
